...
pub fn highlighter_language(language: FileLanguage) -> Language {
    match language {
        ...
        FileLanguage::JavaScript => Language::JavaScript,
        ...
        FileLanguage::Python => Language::Python,
        FileLanguage::Go => Language::Go,
        FileLanguage::CSharp => Language::CSharp,
        FileLanguage::Bash => Language::Bash,
        FileLanguage::C => Language::C,
        FileLanguage::Swift => Language::Swift,
        FileLanguage::Css => Language::Css,
        FileLanguage::Html => Language::Html,
        FileLanguage::Sql => Language::Sql,
        FileLanguage::Toml => Language::Toml,
        FileLanguage::Kotlin => Language::Kotlin,
        FileLanguage::Diff => Language::Diff,
