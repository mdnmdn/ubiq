//! The orchestration screen's own view of the work: what is selected in the graph, which session
...
pub use super::layout::{Algo, CARD_HEIGHT, CARD_WIDTH, GROUP_LABEL, GROUP_PAD, Layout, Rings};
